...
**AquaTriV** is a large-scale, multi-scene, multi-modal underwater dataset designed for **dense SLAM**, **multi-sensor fusion**, and **photorealistic mapping**.
...
|--------|----------|--------|---------------|------|-----------------|------------|
| Abandoned Marina | Harbor | ✗ | IMU, Acoustic, Pressure | ✓ | GPS (Surface) | ✗ |
| ARACATI | River | Mono | IMU, Acoustic | ✗ | DGPS | ✗ |
| Caves Sonar | Cave | Mono | IMU, Acoustic, Pressure | ✓ | Landmarks | ✗ |
| AQUALOC | Sea | Mono | IMU, Pressure | ✓ | Colmap | ✗ |
| Inspection | Tank | Stereo | IMU, Pressure | ✗ | MCS | ✗ |
| HAUD | Pool | Stereo | IMU | ✓ | MCS | ✗ |
| AURORA | Sea | Mono | IMU, Acoustic, Pressure | ✓ | INS | ✗ |
| Seaward | River | ✗ | IMU, Acoustic, Pressure | ✗ | GPS | ✗ |
| Eiffel Tower | Sea | Mono | IMU | ✓ | Colmap | Sparse |
| Tank | Tank | Stereo | IMU, Acoustic, Pressure | ✓ | AprilTag | ✗ |
| **AquaTriV (Ours)** | Pool, Cave, River, Sea | Mono + Stereo + Event + Laser | IMU, Acoustic, Pressure | ✓ | MCS + INS+Colmap | **Dense** |
